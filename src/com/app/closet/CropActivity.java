...
public class CropActivity extends Activity {
	...
	private RelativeLayout		buttonGroup3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonGroup3 = (RelativeLayout) findViewById(R.id.buttonGroup3);

		if (getIntent().hasExtra("ProfileImage")) {
			Bundle extras = getIntent().getExtras();
			profileImage = extras.getBoolean("ProfileImage");
		}
		...
		Button profileButton = (Button) findViewById(R.id.btnSubmit);
		...
		switch (requestCode) {
			...
			case REQUEST_CODE_CROP_IMAGE:
				...
				if (profileImage) {
					...
					buttonGroup3.setVisibility(View.VISIBLE);
				}
				else {
					buttonGroupTop.setVisibility(View.GONE);
